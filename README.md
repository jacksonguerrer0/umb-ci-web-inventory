...
Cada push a `main` ejecuta el pipeline de GitHub Actions con 6 stages: install → lint → test → coverage → sonarcloud + build. El diagrama, las métricas y el porqué de cada umbral están en [CI_REPORT.md](CI_REPORT.md).
